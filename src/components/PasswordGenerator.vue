...
const generatePassword = () => {
    ...
    if(passwordLength.value > maxLength) {
        errorMessage.value = '32 karakterden fazla işlem yapamazsınız';
...
<template>
    <div class="password-generator-container">
        ...
        <label for="includeNumbers">Include Number: </label>
        ...
        <button @click="generatePassword" class="generated-password" :disabled="passwordLength > maxLength">Generate Password</button>
        ...
        <div v-if="generatePassword" class="generate-password">
